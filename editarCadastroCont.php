...
<html>
	...
	<div id="page">
      ...
      <div class="container">
 			 <form method ="POST" action="AtualizarCadastroCont.php" enctype="multipart/form-data">
 			 ...
 			 <div class = "divgrande">
 					 ...
 					 <div class="divfoto">
 						 <img src="<?php echo $array1['endereco']; ?>"  class="avatareditar">
 					 </div>

 					 <div class="form-group">
 						<label for="exampleFormControlFile1">Foto</label>
 						<input type="file" class="divfile" name="foto" required class="form-control-file" >
 					</div>
 					 ...
 					 <input type="hidden" name="foto" value="<?php echo $array1['endereco']?>">
