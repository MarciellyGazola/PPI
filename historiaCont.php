    ...
    <div id="colorlib-container">
				...
				<div class="row">
                  ...
                  <div class="blog-img blog-detail">
        						<img class="img-responsive" src="<?php echo $array2['endereco']?>" alt="html5 bootstrap template">
									...
									<div class="desc">
                    <form action="likeCont.php" method="POST">
										<p class="meta">
                      ...
                      <form action="apagarCont.php" method="POST">
                        <input type='hidden' name='id_hist' value='<?php echo $array1['id_hist'] ?>'>
                        <input type='hidden' name='id_img' value='<?php echo $array2['id_img'] ?>'>
                        <?php
                        ...
                        $id_user6 = $post6['id_user'];

                            if($_SESSION['tipo'] == 3 or $_SESSION['usuario'] == $id_user6){
                              ?>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <form action="comentaCont.php" method="POST">
