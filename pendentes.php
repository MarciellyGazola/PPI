<?php
  ...
  $sql = "select * from historias where estado = 0 order by dataa asc";
...
<html>
 ...
 <div id="page">
   ...
   <div id="colorlib-container">
     <div class="container">
           <h1>Historias ainda pendentes</h1>
           <h4>Aqui estão as histórias que devem ser lidas e revisadas para então serem adicionadas ao site ou não</h4>
    ...
    foreach($result as $post) {
      ...
      echo "<div class='col-md-4'>
       <a href='historiaAdm.php?id=". $post['id_hist']."&id_user=".$post['id_user']."&id_img=".$post2['id_img']."'>
           <div class='blog-entry'>
             ...
             <form action='naoPendente.php' method='POST'>
                <input type='hidden' name='id' value=".$post['id_hist']." />
                <input type='submit' value='Aprovar'style='color: black'/>
             </form>
             <form action='apagarAdm.php' method='POST'>
                <input type='hidden' name='id_hist' value=".$post['id_hist']." />
                <input type='submit' value='Desaprovar' style='color: black'/>
             </form>
           </div>
           </a>
         </div>
