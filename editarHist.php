...
<html>
		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
                ...
                <li><a href="indexAdm.php">Home</a></li>
								<li><a href="historiasAdm.php">Histórias</a></li>
								<li><a href="galeriaAdm.php">Galeria</a></li>
								<li><a href="iffarAdm.php">Sobre o IFFar</a></li>
								<li class="has-dropdown active">
									<a>Perfil</a>
									<ul class="dropdown">
										<li><a href="perfilAdm.php">Ver</a></li>
										<li><a href="editarCadastro.php">Editar</a></li>
   ...
   <div id="colorlib-container">
     <div class="container">
			 <form method ="POST" action="atualizarhist.php" enctype="multipart/form-data">
